...
function touchButtonsLayout() {
  ...
  var layouts = { //function array
    ...
    "JOY2": function () {
      ...
      setPos(touchRotLeft, -1, 1 + oy, buttonW, buttonH, 2, ay, 0, 0, winW, winH);
      setPos(touchRot180, -1, -1 + oy, buttonW, buttonH, 2, ay, 0, 0, winW, winH);
      setPos(touchRotRight, 0, 0 + oy, buttonW, buttonH, 2, ay, 0, 0, winW, winH);
      setPos(touchHold, -2, 0 + oy, buttonW, buttonH, 2, ay, 0, 0, winW, winH);
      setPos(touchRight, 2, 0 + oy, buttonW, buttonH, 0, ay, 0, 0, winW, winH);
      setPos(touchLeft, 0, 0 + oy, buttonW, buttonH, 0, ay, 0, 0, winW, winH);
      setPos(touchDown, 1, 1 + oy, buttonW, buttonH, 0, ay, 0, 0, winW, winH);
      setPos(touchDrop, 1, -1 + oy, buttonW, buttonH, 0, ay, 0, 0, winW, winH);
    },
  ...
  if (currLayout === -2) { // none
    ...
    layouts[["KBD_R", "KBD_L", "JOY", "JOY2", "NARROW", "NARROW_L", "NARROW_LM", "DELUXE"][currLayout]]();
  }
}
